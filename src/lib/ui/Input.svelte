<script lang="ts">
	...
	const dispatch = createEventDispatcher<{
		valuechange: { value: string | number | undefined; raw: string };
		input: Event;
	}>();
	...
	// Emit custom events for parent forms when input changes and update bound value
	function handleInput(e: Event) {
		...
		value = internalValue;
		dispatch('valuechange', { value: internalValue, raw: target.value });
		dispatch('input', e);
	}
